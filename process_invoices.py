...
EXCEL_NAME = "listado_enero.xlsx"  # Asegúrate que coincida con el nombre del Excel del mes
...
excel_df["Total Fra."] = excel_df["Total Fra."].str.replace(".", "", regex=False).str.replace(",", ".").astype(float)
